...
// let sum = 0;
// const salariesAll = Object.values(salaries);
// console.table(salariesAll);

// for (const salary of salariesAll) {
// sum += salary;
// }
// console.log(sum);
...
//     // 1. створити змінну для збереження суми
//     // 2. перебрати масив for of та пройтись по кожному обєкту
//     // 3. вибрати обєкт у якого поле name співпадає зі stoneName
//     // 4. порахувати загальну вартість = ціна*кількість
//     // let totalPrice = 0;
...
//   deposit(amount) {
//     this.balance += amount;
// const transaction = this.creatTransaction(amount, transactionTypes.DEPOSIT);
...
//     this.balance -= amount;
//     const transaction = this.creatTransaction(amount, ttransactionTypes.WITHDRAW);
// this.transactions.push(transaction);
  //   if (amount > this.balance) {
  //     console.log("Недостатньо коштів");
  //     return false;
